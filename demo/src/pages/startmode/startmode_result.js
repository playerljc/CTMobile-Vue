    ...
    return (
      <React.Fragment>
        ...
        <div className="ct-content" style={{top: '3rem', bottom: 0}}>
          <ul>
            <li><Link className="link" pageId="startmode_result_moretoone">startmode_result_moretoone(多对一)</Link></li>
            <li><Link className="link" pageId="startmode_result_onetomore">startmode_result_onetomore(一对多)</Link></li>
          </ul>
        </div>
      </React.Fragment>
    );
