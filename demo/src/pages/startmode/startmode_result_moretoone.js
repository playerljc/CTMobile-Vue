    ...
    return (
      <React.Fragment>
        ...
        <div className="ct-content" style={{top: '3rem', bottom: 0}}>
          <ul>
            <li><Link className="link" pageId="startmode_result_moretoone_page1">startmode_result_moretoone_page1</Link></li>
            <li><Link className="link" pageId="startmode_result_moretoone_page2">startmode_result_moretoone_page2</Link></li>
          </ul>
        </div>
      </React.Fragment>
    );
