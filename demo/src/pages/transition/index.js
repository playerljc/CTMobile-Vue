    ...
    return (
      <React.Fragment>
        ...
        <div className="ct-content" style={{top: '3rem', bottom: 0}}>
          <ul>
            <li><Link className="link" pageId="transition_noreload">增加历史</Link></li>
            <li><Link className="link" pageId="transition_reload">不增加历史</Link></li>
            <li><Link className="link" pageId="transition_mode">转场效果</Link></li>
          </ul>
        </div>
      </React.Fragment>
    );
